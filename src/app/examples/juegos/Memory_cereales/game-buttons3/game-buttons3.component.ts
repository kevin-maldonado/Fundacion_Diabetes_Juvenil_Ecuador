...
@Component({
  selector: 'app-game-buttons3',
  templateUrl: './game-buttons3.component.html',
  styleUrls: ['./game-buttons3.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class GameButtons3Component implements OnInit, OnDestroy {
   ...
   */
  playGame(): void {
    this.cerealesService.startGame();
  }
